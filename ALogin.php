        ...
        <section class="login-clean" style="background: rgba(241,247,252,0);">
            <form method="POST" action=" ">
                <div class="illustration"><img src="assets/img/B-empowered-logo.png" style="width: 100px;">
                    <p style="color: #22a900;font-size: 15px;text-align: left;margin-top: 10px;margin-bottom: 0;"><strong>Administrator Portal</strong></p>
                </div>
                <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="Username"></div>
                <div class="mb-3"><input class="form-control" type="password" name="password" placeholder="Password"></div>
                <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: #22a900;" name="submitAdm">Log In</button></div>
            </form>
        </section>
    </div>
